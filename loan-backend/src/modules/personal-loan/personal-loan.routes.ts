...
import { apply } from './personal-loan.controller';

const applyPersonalLoanSchema = z.object({
  body: z.object({
...
router.post('/apply', authenticate, validateRequest(applyPersonalLoanSchema), apply);
